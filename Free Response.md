...
main() runs the function game(qa)
there are input options on an html where the person clicks on a choice and it checks if the answwer is correct based on the json revieved from an api.
